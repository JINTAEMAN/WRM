...
public class InitController {
	...
	public String IndexBase(HttpServletRequest request, Model model) throws Exception {
		System.out.println("[/InitController.java] [IndexBase()] ==> [TEST_01] [기본 Root Url 처리] [w2xPath]"+ request.getParameter("w2xPath") ); 
	...
	private String getLoginPage(String w2xPath) {
		System.out.println("[/InitController.java] [getLoginPage()] ==> [TEST_01] [로그인 페이지 Url 반환] [w2xPath]"+ w2xPath ); 
		
		String movePage = w2xPath;
		System.out.println("[/InitController.java] [getLoginPage()] ==> [TEST_11] [userInfo.isLogined()]"+ userInfo.isLogined() ); 
