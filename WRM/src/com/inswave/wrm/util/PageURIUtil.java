...
public class PageURIUtil {
	...
	private void setLOGIN_PAGE(String login_page) {
		System.out.println("[/PageURIUtil..java] [setLOGIN_PAGE()] ==> [TEST_01] [LOGIN_PAGE 설정] [login_page]"+ login_page ); 
	...
	public static String getLoginPage() {
		System.out.println("[/PageURIUtil..java] [getLoginPage()] ==> [TEST_01] [LOGIN_PAGE 가져오기] [LOGIN_PAGE]"+ LOGIN_PAGE ); 
